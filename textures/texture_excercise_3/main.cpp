...
int main()
{
	...
	glGenBuffers(1, &EBO);//element buffer, sorts the order to draw shapes
	...
	while (!glfwWindowShouldClose(window)){
		...
		shader.setFloat("face_opacity",face_opacity);
		std::cout<<"opacity: "<<face_opacity<<std::endl;
		shader.use();
		glBindVertexArray(VAO);
