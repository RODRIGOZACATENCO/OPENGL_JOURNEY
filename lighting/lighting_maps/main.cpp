...
constexpr int SPECULAR_TEXTURE_ID=1;
constexpr int MATRIX_TEXTURE_ID=2;
...
int main() {
	...
	box_texture.use();
	shader.setInt("material.diffuse", BOX_TEXTURE_ID);

	Texture2d specular_box_texture=Texture2d(std::string(ROOT_DIR)+"textures/container_specular.png",SPECULAR_TEXTURE_ID);
	specular_box_texture.setWrapMode(GL_REPEAT,GL_REPEAT);
	specular_box_texture.use();
	shader.setInt("material.specular", SPECULAR_TEXTURE_ID);

	Texture2d matrix_texture=Texture2d(std::string(ROOT_DIR)+"textures/matrix.jpg",MATRIX_TEXTURE_ID);
	matrix_texture.setWrapMode(GL_REPEAT,GL_REPEAT);
	matrix_texture.use();
	shader.setInt("material.emission", MATRIX_TEXTURE_ID);
